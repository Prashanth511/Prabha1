...
public class EditProduct extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<table>");
		out.print("<tr><td></td><td><input type='hidden' name='id' value="+e.getProductId()+"></td></tr>");
		out.print("<tr><td>productname:</td><td><input type='text' name='name' value='"+e.getProductName()+"'/></td></tr>");
		out.print("<tr><td>productprice:</td><td><input type='text' name='price' value='"+e.getProductPrice()+"'/></td></tr>");
